...
describe('Character', function() {
    ...
    beforeEach(function(){
        testCharacter = new Character(new Vector(1,1), 20, 10, true, new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), 60, 40);
    });
    ...
    it('should return an empty object due to invalid max health', function() {
        testCharacter=  new Character(new Vector(0,0), "bad", 10, true, new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), 60, 40);
        expect(testCharacter).toEqual({});
    });

    it('should return an empty object due to invalid health', function() {
        testCharacter=  new Character(new Vector(0,0), 20, "bad", true, new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), 60, 40);
        expect(testCharacter).toEqual({});
    });

    it('should return an empty object due to invalid status', function() {
        testCharacter=  new Character(new Vector(0,0), 20, 10, "bad", new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), 60, 40);
        expect(testCharacter).toEqual({});
    });

    it('should return an empty object due to invalid speed', function() {
        testCharacter=  new Character(new Vector(0,0), 20, 10, true, new Vector(50,50), 'url', new Vector(50,50), "bad", 60, 40);
        expect(testCharacter).toEqual({});
    });

    it('should return an empty object due to invalid movement speed', function() {
        testCharacter=  new Character(new Vector(0,0), 20, 10, true, new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), "bad", 40);
        expect(testCharacter).toEqual({});
    });

    it('should return an empty object due to invalid gravity', function() {
        testCharacter=  new Character(new Vector(0,0), 20, 10, true, new Vector(50,50), 'url', new Vector(50,50), new Vector(0,0), 60, "bad");
        expect(testCharacter).toEqual({});
    });
    ...
    it('should fail to set gravaity due to invalid input', function(){
    ...
    it('should move x to newpos because of non-solid obstacle', function(){
        testEnvironment =  new Environment(false, new Vector(1,1), null, new Vector(50,10), new Vector(20,50));
        testCharacter.moveX(new Vector(61,1), testEnvironment);
        expect(testCharacter.getPosition()).toEqual(new Vector(61,1));
    });

    it('should not move x to newpos because of solid obstacle', function(){
        testEnvironment =  new Environment(true, new Vector(1,1), null, new Vector(50,10), new Vector(20,50));
        testCharacter.moveX(new Vector(61,1), testEnvironment);
        expect(testCharacter.getPosition()).toEqual(new Vector(1,1));
    });
    ...
    it('should not move y to newpos because of solid obstacle and set yspeed to 0', function(){
        testEnvironment =  new Environment(true, new Vector(1,1), null, new Vector(50,10), new Vector(20,50));
    ...
    it('should not move y to newpos because of solid obstacle and set yspeed to -70', function(){
        testEnvironment =  new Environment(true, new Vector(1,1), null, new Vector(50,10), new Vector(20,50));
